...
of the partition, users need to run 'parallel_mArch_main.py',
'mArch_loss_calculation.py' and 'parallel_mArch_mcs_partition.py' prior to
running this script, so that both sets of results are available.
